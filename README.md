...
Data analyst and polymer chemist. I work on different types of data: measurements from laboratories and production such as spectra and process parameters, and market and provision data in diagnostics and healthcare.
